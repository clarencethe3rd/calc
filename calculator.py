...
display = StringVar()
entry = Entry(textvariable=display,width=14,font=("",26))
entry.place(x=0,y=0)
...
button_x = Button(grid1,text= "x", font=("",25),command=lambda: press(x))
...
button_equal = Button(grid1,text= "=", font=("",25),)
button_del = Button(grid1,text="Del", font=("",25))
